...
-(void)makeMenu
{
    QuadCurveMenuItem *all = [[QuadCurveMenuItem alloc] initWithImage:[UIImage imageNamed:@"btn_all.png"]
    ...
    // People MenuItem.
    QuadCurveMenuItem *play = [[QuadCurveMenuItem alloc] initWithImage:[UIImage imageNamed:@"btn_play.png"]
    ...
    // Place MenuItem.
    QuadCurveMenuItem *bath = [[QuadCurveMenuItem alloc] initWithImage:[UIImage imageNamed:@"btn_bath.png"]
    ...
    // Music MenuItem.
    QuadCurveMenuItem *feed = [[QuadCurveMenuItem alloc] initWithImage:[UIImage imageNamed:@"btn_feed.png"]
    ...
    // Thought MenuItem.
    QuadCurveMenuItem *sleep = [[QuadCurveMenuItem alloc] initWithImage:[UIImage imageNamed:@"btn_sleep.png"]
    ...
    // Sleep MenuItem.
    QuadCurveMenuItem *diaper = [[QuadCurveMenuItem alloc] initWithImage:[UIImage imageNamed:@"btn_diaper.png"]
    ...
    NSArray *menus = [NSArray arrayWithObjects:all, play, bath, feed, sleep, diaper, nil];
    CGRect rx = [ UIScreen mainScreen ].bounds;
